...
/**
 * Custom queries for {@link Note}. Visibility rules match {@link TodoListRepositoryImpl}.
 */
@Repository
public class NoteRepositoryImpl implements NoteRepositoryCustom {
    ...
    @Override
    public List<Note> findAccessibleByMember(String memberId) {
    ...
    @Override
    public Optional<Note> findAccessibleByIdAndMember(String id, String memberId) {
