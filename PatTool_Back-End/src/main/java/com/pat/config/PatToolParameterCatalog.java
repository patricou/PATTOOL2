...
public final class PatToolParameterCatalog {
    ...
    public static final List<SectionDef> SECTIONS = List.of(
            ...
            section("weather-maps", "PATTOOL_PARAMS.SECTION.WEATHER_MAPS",
                    ...
                    def("meteofrance.forecast.run-prefetch.enabled", false),
                    def("meteofrance.forecast.run-prefetch.cron", false),
                    def("meteofrance.forecast.run-prefetch.lat", false),
                    def("meteofrance.forecast.run-prefetch.lon", false),
            ...
            section("external-proxies", "PATTOOL_PARAMS.SECTION.EXTERNAL_PROXIES",
                    ...
                    def("app.foncier.geo.api-base", false),
                    def("app.foncier.cerema.api-base", false),
                    def("app.foncier.stream-estate.api-base", false),
                    ...
                    def("app.skymap.search-base", false),
                    def("app.skymap.imgcut-base", false),
                    def("app.skymap.atlas-base", false),
                    ...
                    def("app.book.openlibrary-base-url", false),
                    def("app.book.gutendex-base-url", false),
                    def("app.book.librivox-base-url", false),
                    def("app.book.archive-base-url", false),
                    def("app.book.google-books-base-url", false),
                    defSensitive("app.book.google-api-key"),
                    def("app.book.standardebooks-base-url", false),
                    def("app.book.search-cache-minutes", false),
                    def("app.webcam.windy-api-base", false),
                    defSensitive("app.webcam.windy-api-key"),
                    def("app.webcam.road511-api-base", false),
            ...
            section("cache-memory", "PATTOOL_PARAMS.SECTION.CACHE_MEMORY",
                    ...
                    def("app.video.montage.enabled", false),
                    def("app.video.montage.max-clips", false),
                    def("app.video.montage.max-duration-sec", false),
