    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                headers
                    ...
                    .contentSecurityPolicy(csp -> csp
                        .policyDirectives("default-src 'self'; " +
                            ...
                            "connect-src 'self' blob: http://localhost:8080 http://localhost:8000 https://www.patrickdeschamps.com:8543 https://cdn.jsdelivr.net https://*.googleapis.com https://www.googleapis.com https://*.gstatic.com https://www.gstatic.com https://nominatim.openstreetmap.org https://api.open-elevation.com https://*.basemaps.cartocdn.com https://basemaps.cartocdn.com https://tile.openstreetmap.org https://*.tile.openstreetmap.org ws://localhost:8000 http://localhost:8000/ws; " +
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers(HttpMethod.POST, "/api/external/weather/elevation/batch").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/external/radio/podcasts/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/external/radio/stream", "/api/external/radio/stream/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/external/book/openlibrary/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/external/book/gutenberg/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/external/book/librivox/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/external/book/archive/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/external/book/google/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/external/book/standardebooks/**").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/external/archive/search").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/external/archive/catalog-cache/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/external/archive/catalog-cache/**").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/external/artisans/nearby", "/api/external/artisans/website", "/api/external/artisans/cache").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/external/artisans/cache/clear").permitAll()
