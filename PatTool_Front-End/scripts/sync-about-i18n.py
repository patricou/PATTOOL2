...
ABOUT_EN = {
    "TITLE": "About PatTool",
    "SUBTITLE": "Full-stack platform for sportive events, friends, tools, IoT, the sky and the world — designed and built end to end.",
    ...
    "INTRO": "PatTool is a private social network for organizing sportive activities, with discussions, photo wall, calendar, AI assistant, geo tools, sky finder, compass, Wikipedia, media watchers and home automation.",
    ...
    "FEAT_NOTES": "Personal sticky notes",
    ...
    "FEAT_GLOBE": "3D Earth, live ISS, look-up compass, alerts and flights",
    "FEAT_SOLAR": "Solar-system planets and orbits",
    "FEAT_SKY": "Sky chart and constellations",
    "FEAT_ECLIPSE": "Solar and lunar eclipses",
    "FEAT_ASTRO": "Camera finder: planets, stars, galaxies, ISS; auto-detect; last target saved; Wikipedia card",
    "FEAT_COMPASS": "True-north compass, figure-8 calibration and phone sensors",
    "FEAT_DIRECTION": "7-pose camera calibration (azimuth + elevation) for the finder",
    "FEAT_WIKI": "Wikipedia search: summary, image and article link",
...
ABOUT_FR = {
    ...
    "SUBTITLE": "Plateforme full-stack pour activités sportives, amis, outils, IoT, ciel et le monde — conçue et réalisée de bout en bout.",
    ...
    "VERSION": "Version 2.0.1",
    "INTRO": "PatTool est un réseau social privé pour organiser des activités sportives, avec discussions, mur de photos, calendrier, assistant IA, outils géo, viseur d’astres, boussole, Wikipédia, médias et domotique.",
    ...
    "FEAT_NOTES": "Notes personnelles (post-it)",
    ...
    "FEAT_GLOBE": "Globe 3D, ISS en direct, boussole « où regarder », alertes et vols",
    "FEAT_SOLAR": "Planètes et orbites du système solaire",
    "FEAT_SKY": "Carte du ciel et constellations",
    "FEAT_ECLIPSE": "Éclipses solaires et lunaires",
    "FEAT_ASTRO": "Viseur caméra : planètes, étoiles, galaxies, ISS ; auto-détection ; dernier astre mémorisé ; fiche Wikipédia",
    "FEAT_COMPASS": "Boussole Nord géographique, calage figure-8 et capteurs du téléphone",
    "FEAT_DIRECTION": "Calibrage 7 poses (azimut + élévation) pour le viseur",
    "FEAT_WIKI": "Recherche Wikipédia : résumé, image et lien d’article",
