...
export const ASTRO_SATELLITES: ReadonlyArray<AstroSatelliteOption> = [
  ...
  },
  {
    ...
    kind: 'iss',
    noradId: 43435,
    labelKey: 'ASTRO_COMPASS.BODY_TESS',
    iconClass: 'fa fa-search',
    color: '#fbbf24',
    defaultAltKm: 100_000
  },
  {
    id: 'chandra',
    kind: 'iss',
    noradId: 25867,
    labelKey: 'ASTRO_COMPASS.BODY_CHANDRA',
    iconClass: 'fa fa-star',
    color: '#a78bfa',
    defaultAltKm: 80_000
  },
  {
    ...
    kind: 'iss',
    noradId: 25989,
    labelKey: 'ASTRO_COMPASS.BODY_XMM',
    iconClass: 'fa fa-star',
    color: '#818cf8',
    defaultAltKm: 60_000
  },
  {
    ...
    kind: 'iss',
    noradId: 57800,
    labelKey: 'ASTRO_COMPASS.BODY_XRISM',
    iconClass: 'fa fa-star',
    color: '#c4b5fd',
    defaultAltKm: 550
  },
  {
    ...
    kind: 'iss',
    noradId: 57219,
    labelKey: 'ASTRO_COMPASS.BODY_EUCLID',
    iconClass: 'fa fa-star',
    color: '#f0abfc',
    defaultAltKm: 1_500_000,
    skipLiveTle: true,
  ...
  },
  {
    ...
    kind: 'iss',
    noradId: 39479,
    labelKey: 'ASTRO_COMPASS.BODY_GAIA',
    iconClass: 'fa fa-star',
    color: '#e879f9',
    defaultAltKm: 1_500_000,
    skipLiveTle: true,
  ...
  },
  {
    ...
    kind: 'iss',
    noradId: 33591,
    labelKey: 'ASTRO_COMPASS.BODY_NOAA19',
    iconClass: 'fa fa-cloud',
    color: '#7dd3fc',
    defaultAltKm: 870
  },
  {
    ...
    kind: 'iss',
    noradId: 41866,
    labelKey: 'ASTRO_COMPASS.BODY_GOES16',
    iconClass: 'fa fa-cloud',
    color: '#38bdf8',
    defaultAltKm: 35_786
  },
  {
    ...
    kind: 'iss',
    noradId: 40732,
    labelKey: 'ASTRO_COMPASS.BODY_METEOSAT11',
    iconClass: 'fa fa-cloud',
    color: '#22d3ee',
    defaultAltKm: 35_786
  },
  {
    ...
    kind: 'iss',
    noradId: 54743,
    labelKey: 'ASTRO_COMPASS.BODY_MTGI1',
    iconClass: 'fa fa-cloud',
    color: '#06b6d4',
    defaultAltKm: 35_786
  },
  {
    ...
    kind: 'iss',
    noradId: 41836,
    labelKey: 'ASTRO_COMPASS.BODY_HIMAWARI9',
  ...
  },
  {
    ...
    kind: 'iss',
    noradId: 38012,
    labelKey: 'ASTRO_COMPASS.BODY_PLEIADES1A',
  ...
  },
  {
    ...
    kind: 'iss',
    noradId: 38755,
    labelKey: 'ASTRO_COMPASS.BODY_SPOT6',
    iconClass: 'fa fa-camera',
    color: '#65a30d',
    defaultAltKm: 694
  },
  {
    ...
    kind: 'iss',
    noradId: 54754,
    labelKey: 'ASTRO_COMPASS.BODY_SWOT',
  ...
  },
  {
    ...
    kind: 'iss',
    noradId: 43613,
    labelKey: 'ASTRO_COMPASS.BODY_ICESAT2',
  ...
  },
  {
    ...
    kind: 'iss',
    noradId: 53807,
    labelKey: 'ASTRO_COMPASS.BODY_BLUEWALKER3',
    iconClass: 'fa fa-rss',
    color: '#60a5fa',
    defaultAltKm: 515
  },
  {
    ...
    kind: 'iss',
    noradId: 44624,
    labelKey: 'ASTRO_COMPASS.BODY_EUTELSAT5W',
  ...
  },
  {
    ...
    kind: 'iss',
    noradId: 54048,
    labelKey: 'ASTRO_COMPASS.BODY_HOTBIRD13',
    iconClass: 'fa fa-desktop',
    color: '#fb7185',
    defaultAltKm: 35_786
  }
...
export const ASTRO_BRIGHT_STARS: ReadonlyArray<AstroStarOption> = [
  ...
  { id: 'aljanah', kind: 'star', name: 'Aljanah', aliases: ['epsilon cygni', 'ε cyg', 'gienah cygni'], raHours: 20.7702, decDeg: 33.9703, distLy: 73, mag: 2.48, constellation: 'Cyg', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'fawaris', kind: 'star', name: 'Fawaris', aliases: ['delta cygni', 'δ cyg'], raHours: 19.7495, decDeg: 45.1308, distLy: 165, mag: 2.87, constellation: 'Cyg', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'rutilicus', kind: 'star', name: 'Rutilicus', aliases: ['zeta herculis', 'ζ her'], raHours: 16.6881, decDeg: 31.6027, distLy: 35, mag: 2.81, constellation: 'Her', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'pi-her', kind: 'star', name: 'Pi Herculis', aliases: ['pi herculis', 'π her'], raHours: 17.2508, decDeg: 36.8092, distLy: 377, mag: 3.16, constellation: 'Her', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'eta-her', kind: 'star', name: 'Eta Herculis', aliases: ['eta herculis', 'η her'], raHours: 16.7142, decDeg: 38.9225, distLy: 112, mag: 3.53, constellation: 'Her', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'epsilon-her', kind: 'star', name: 'Epsilon Herculis', aliases: ['epsilon herculis', 'ε her'], raHours: 17.0047, decDeg: 30.9203, distLy: 155, mag: 3.92, constellation: 'Her', iconClass: 'fa fa-star', color: '#fff0d8' },
  { id: 'mahasim', kind: 'star', name: 'Mahasim', aliases: ['theta aurigae', 'θ aur'], raHours: 5.9954, decDeg: 37.2126, distLy: 166, mag: 2.62, constellation: 'Aur', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'haedus', kind: 'star', name: 'Haedus', aliases: ['eta aurigae', 'η aur'], raHours: 5.1086, decDeg: 41.2346, distLy: 243, mag: 3.17, constellation: 'Aur', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'atik', kind: 'star', name: 'Atik', aliases: ['zeta persei', 'ζ per'], raHours: 3.9025, decDeg: 31.8836, distLy: 750, mag: 2.85, constellation: 'Per', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'arneb', kind: 'star', name: 'Arneb', aliases: ['alpha leporis', 'α lep'], raHours: 5.5455, decDeg: -17.8226, distLy: 2210, mag: 2.58, constellation: 'Lep', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'nihal', kind: 'star', name: 'Nihal', aliases: ['beta leporis', 'β lep'], raHours: 5.2155, decDeg: -20.7558, distLy: 160, mag: 2.81, constellation: 'Lep', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'okab', kind: 'star', name: 'Okab', aliases: ['zeta aquilae', 'ζ aql'], raHours: 19.0902, decDeg: 13.8635, distLy: 83, mag: 2.99, constellation: 'Aql', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'men', kind: 'star', name: 'Men', aliases: ['alpha lupi', 'α lup'], raHours: 14.6988, decDeg: -47.3883, distLy: 460, mag: 2.30, constellation: 'Lup', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'kekouan', kind: 'star', name: 'Kekouan', aliases: ['beta lupi', 'β lup'], raHours: 14.9755, decDeg: -43.1339, distLy: 383, mag: 2.68, constellation: 'Lup', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'gamma-lup', kind: 'star', name: 'Gamma Lupi', aliases: ['gamma lupi', 'γ lup'], raHours: 15.5857, decDeg: -41.1667, distLy: 420, mag: 2.80, constellation: 'Lup', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'choo', kind: 'star', name: 'Choo', aliases: ['alpha arae', 'α ara'], raHours: 17.5307, decDeg: -49.8761, distLy: 270, mag: 2.84, constellation: 'Ara', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'alpha-mus', kind: 'star', name: 'Alpha Muscae', aliases: ['alpha muscae', 'α mus'], raHours: 12.5411, decDeg: -69.1356, distLy: 315, mag: 2.69, constellation: 'Mus', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'alpha-tuc', kind: 'star', name: 'Alpha Tucanae', aliases: ['alpha tucanae', 'α tuc'], raHours: 22.3084, decDeg: -60.2596, distLy: 200, mag: 2.86, constellation: 'Tuc', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'head-hyi', kind: 'star', name: 'Head of Hydrus', aliases: ['alpha hydri', 'α hyi'], raHours: 1.9796, decDeg: -61.5697, distLy: 72, mag: 2.86, constellation: 'Hyi', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'beta-hyi', kind: 'star', name: 'Beta Hydri', aliases: ['beta hydri', 'β hyi'], raHours: 0.4305, decDeg: -77.2542, distLy: 24, mag: 2.80, constellation: 'Hyi', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'sigma-oct', kind: 'star', name: 'Sigma Octantis', aliases: ['sigma octantis', 'σ oct', 'south pole star', 'etoile polaire sud'], raHours: 21.1444, decDeg: -88.9564, distLy: 270, mag: 5.47, constellation: 'Oct', iconClass: 'fa fa-star', color: '#cfe0ff' },
  { id: 'nu-oct', kind: 'star', name: 'Nu Octantis', aliases: ['nu octantis', 'ν oct'], raHours: 21.6912, decDeg: -77.3875, distLy: 69, mag: 3.76, constellation: 'Oct', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'athebyn', kind: 'star', name: 'Athebyne', aliases: ['eta draconis', 'η dra'], raHours: 16.3994, decDeg: 61.5142, distLy: 92, mag: 2.74, constellation: 'Dra', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'kraz', kind: 'star', name: 'Kraz', aliases: ['beta corvi', 'β crv'], raHours: 12.5711, decDeg: -23.3966, distLy: 146, mag: 2.65, constellation: 'Crv', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'minkar', kind: 'star', name: 'Minkar', aliases: ['epsilon corvi', 'ε crv'], raHours: 12.1688, decDeg: -22.6197, distLy: 303, mag: 3.02, constellation: 'Crv', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'alchiba', kind: 'star', name: 'Alchiba', aliases: ['alpha corvi', 'α crv'], raHours: 12.1402, decDeg: -24.7285, distLy: 48, mag: 4.02, constellation: 'Crv', iconClass: 'fa fa-star', color: '#fff0d8' },
  { id: 'mothallah', kind: 'star', name: 'Mothallah', aliases: ['alpha trianguli', 'α tri'], raHours: 1.8847, decDeg: 29.5788, distLy: 63, mag: 3.42, constellation: 'Tri', iconClass: 'fa fa-star', color: '#fff0d8' },
  { id: 'deltoton', kind: 'star', name: 'Deltoton', aliases: ['beta trianguli', 'β tri'], raHours: 2.1591, decDeg: 34.9873, distLy: 127, mag: 3.00, constellation: 'Tri', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'alrescha', kind: 'star', name: 'Alrescha', aliases: ['alpha piscium', 'α psc'], raHours: 2.0344, decDeg: 2.7636, distLy: 139, mag: 3.82, constellation: 'Psc', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'kullat', kind: 'star', name: 'Kullat Nunu', aliases: ['eta piscium', 'η psc'], raHours: 1.5244, decDeg: 15.3456, distLy: 350, mag: 3.62, constellation: 'Psc', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'gamma-psc', kind: 'star', name: 'Gamma Piscium', aliases: ['gamma piscium', 'γ psc'], raHours: 23.2872, decDeg: 3.2822, distLy: 138, mag: 3.70, constellation: 'Psc', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'iota-psc', kind: 'star', name: 'Iota Piscium', aliases: ['iota piscium', 'ι psc'], raHours: 23.6656, decDeg: 5.6261, distLy: 45, mag: 4.13, constellation: 'Psc', iconClass: 'fa fa-star', color: '#fff0d8' },
  { id: 'theta-psc', kind: 'star', name: 'Theta Piscium', aliases: ['theta piscium', 'θ psc'], raHours: 23.4664, decDeg: 6.3789, distLy: 159, mag: 4.27, constellation: 'Psc', iconClass: 'fa fa-star', color: '#fff0d8' },
  { id: 'lambda-psc', kind: 'star', name: 'Lambda Piscium', aliases: ['lambda piscium', 'λ psc'], raHours: 23.7008, decDeg: 1.7803, distLy: 101, mag: 4.49, constellation: 'Psc', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'kappa-psc', kind: 'star', name: 'Kappa Piscium', aliases: ['kappa piscium', 'κ psc'], raHours: 23.4494, decDeg: 1.2556, distLy: 162, mag: 4.95, constellation: 'Psc', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'eta-leo', kind: 'star', name: 'Al Jabhah', aliases: ['eta leonis', 'η leo'], raHours: 10.1222, decDeg: 16.7628, distLy: 1270, mag: 3.49, constellation: 'Leo', iconClass: 'fa fa-star', color: '#fff0d8' },
  { id: 'hyadum1', kind: 'star', name: 'Hyadum I', aliases: ['gamma tauri', 'γ tau', 'prima hyadum'], raHours: 4.3281, decDeg: 15.6275, distLy: 161, mag: 3.65, constellation: 'Tau', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'hyadum2', kind: 'star', name: 'Hyadum II', aliases: ['delta tauri', 'δ tau', 'secunda hyadum'], raHours: 4.3822, decDeg: 17.5425, distLy: 153, mag: 3.76, constellation: 'Tau', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'alnasl', kind: 'star', name: 'Alnasl', aliases: ['gamma sagittarii', 'γ sgr', 'nash'], raHours: 18.0968, decDeg: -30.4241, distLy: 96, mag: 2.98, constellation: 'Sgr', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'nanto', kind: 'star', name: 'Nanto', aliases: ['phi sagittarii', 'φ sgr'], raHours: 18.7608, decDeg: -26.9908, distLy: 239, mag: 3.17, constellation: 'Sgr', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'double-double', kind: 'star', name: 'Epsilon Lyrae', aliases: ['epsilon lyrae', 'ε lyr', 'double double'], raHours: 18.7366, decDeg: 39.6703, distLy: 160, mag: 4.67, constellation: 'Lyr', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'delta-cep', kind: 'star', name: 'Delta Cephei', aliases: ['delta cephei', 'δ cep'], raHours: 22.2506, decDeg: 58.4152, distLy: 887, mag: 4.07, constellation: 'Cep', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'sualocin', kind: 'star', name: 'Sualocin', aliases: ['alpha delphini', 'α del'], raHours: 20.6606, decDeg: 15.9121, distLy: 241, mag: 3.77, constellation: 'Del', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'rotanev', kind: 'star', name: 'Rotanev', aliases: ['beta delphini', 'β del'], raHours: 20.6258, decDeg: 14.5951, distLy: 97, mag: 3.63, constellation: 'Del', iconClass: 'fa fa-star', color: '#fff0d8' },
  { id: 'sham', kind: 'star', name: 'Sham', aliases: ['alpha sagittae', 'α sge'], raHours: 19.6550, decDeg: 18.0139, distLy: 470, mag: 4.37, constellation: 'Sge', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'anser', kind: 'star', name: 'Anser', aliases: ['alpha vulpeculae', 'α vul'], raHours: 19.4784, decDeg: 24.6649, distLy: 297, mag: 4.44, constellation: 'Vul', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'acubens', kind: 'star', name: 'Acubens', aliases: ['alpha cancri', 'α cnc'], raHours: 8.9748, decDeg: 11.8578, distLy: 174, mag: 4.26, constellation: 'Cnc', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'tarf', kind: 'star', name: 'Tarf', aliases: ['beta cancri', 'β cnc'], raHours: 8.2753, decDeg: 9.1856, distLy: 290, mag: 3.52, constellation: 'Cnc', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'asellus-australis', kind: 'star', name: 'Asellus Australis', aliases: ['delta cancri', 'δ cnc'], raHours: 8.7448, decDeg: 18.1542, distLy: 131, mag: 3.94, constellation: 'Cnc', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'nusakan', kind: 'star', name: 'Nusakan', aliases: ['beta coronae borealis', 'β crb'], raHours: 15.4638, decDeg: 29.1058, distLy: 114, mag: 3.68, constellation: 'CrB', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'chara', kind: 'star', name: 'Chara', aliases: ['beta canum venaticorum', 'β cvn'], raHours: 12.5624, decDeg: 41.3575, distLy: 27, mag: 4.24, constellation: 'CVn', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'muscida', kind: 'star', name: 'Muscida', aliases: ['omicron ursae majoris', 'ο uma'], raHours: 8.5044, decDeg: 60.7183, distLy: 184, mag: 3.35, constellation: 'UMa', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'zeta-umi', kind: 'star', name: 'Zeta Ursae Minoris', aliases: ['zeta ursae minoris', 'ζ umi'], raHours: 15.7343, decDeg: 77.7945, distLy: 369, mag: 4.32, constellation: 'UMi', iconClass: 'fa fa-star', color: '#cfe0ff' },
  { id: 'epsilon-umi', kind: 'star', name: 'Epsilon Ursae Minoris', aliases: ['epsilon ursae minoris', 'ε umi'], raHours: 16.7662, decDeg: 82.0372, distLy: 347, mag: 4.21, constellation: 'UMi', iconClass: 'fa fa-star', color: '#cfe0ff' },
  { id: 'eta-umi', kind: 'star', name: 'Eta Ursae Minoris', aliases: ['eta ursae minoris', 'η umi'], raHours: 16.2917, decDeg: 75.7553, distLy: 97, mag: 4.95, constellation: 'UMi', iconClass: 'fa fa-star', color: '#cfe0ff' },
  { id: 'sadachbia', kind: 'star', name: 'Sadachbia', aliases: ['gamma aquarii', 'γ aqr'], raHours: 22.3609, decDeg: -1.3873, distLy: 164, mag: 3.86, constellation: 'Aqr', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'alkes', kind: 'star', name: 'Alkes', aliases: ['alpha crateris', 'α crt'], raHours: 10.9963, decDeg: -18.2987, distLy: 160, mag: 4.08, constellation: 'Crt', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'gamma-hya', kind: 'star', name: 'Gamma Hydrae', aliases: ['gamma hydrae', 'γ hya'], raHours: 13.3154, decDeg: -23.1714, distLy: 134, mag: 3.00, constellation: 'Hya', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'pi-pup', kind: 'star', name: 'Pi Puppis', aliases: ['pi puppis', 'π pup'], raHours: 7.2856, decDeg: -37.0975, distLy: 780, mag: 2.70, constellation: 'Pup', iconClass: 'fa fa-star', color: '#ff9a4a' },
  { id: 'tau-pup', kind: 'star', name: 'Tau Puppis', aliases: ['tau puppis', 'τ pup'], raHours: 6.8300, decDeg: -50.6147, distLy: 182, mag: 2.94, constellation: 'Pup', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'alpha-dor', kind: 'star', name: 'Alpha Doradus', aliases: ['alpha doradus', 'α dor'], raHours: 4.5666, decDeg: -55.0446, distLy: 169, mag: 3.27, constellation: 'Dor', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'alpha-pic', kind: 'star', name: 'Alpha Pictoris', aliases: ['alpha pictoris', 'α pic'], raHours: 6.8032, decDeg: -61.9410, distLy: 97, mag: 3.27, constellation: 'Pic', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'alpha-ind', kind: 'star', name: 'Alpha Indi', aliases: ['alpha indi', 'α ind'], raHours: 20.6261, decDeg: -47.2917, distLy: 101, mag: 3.11, constellation: 'Ind', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'alpha-tel', kind: 'star', name: 'Alpha Telescopii', aliases: ['alpha telescopii', 'α tel'], raHours: 18.4457, decDeg: -45.9544, distLy: 278, mag: 3.51, constellation: 'Tel', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'alpha-cir', kind: 'star', name: 'Alpha Circini', aliases: ['alpha circini', 'α cir'], raHours: 14.7084, decDeg: -64.9751, distLy: 54, mag: 3.19, constellation: 'Cir', iconClass: 'fa fa-star', color: '#fff0d8' },
  { id: 'alpha-pyx', kind: 'star', name: 'Alpha Pyxidis', aliases: ['alpha pyxidis', 'α pyx'], raHours: 8.7265, decDeg: -33.1864, distLy: 880, mag: 3.68, constellation: 'Pyx', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'alpha-lyn', kind: 'star', name: 'Alpha Lyncis', aliases: ['alpha lyncis', 'α lyn'], raHours: 9.3510, decDeg: 34.3925, distLy: 203, mag: 3.14, constellation: 'Lyn', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'alpha-lac', kind: 'star', name: 'Alpha Lacertae', aliases: ['alpha lacertae', 'α lac'], raHours: 22.5214, decDeg: 50.2825, distLy: 103, mag: 3.77, constellation: 'Lac', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'alpha-mon', kind: 'star', name: 'Alpha Monocerotis', aliases: ['alpha monocerotis', 'α mon'], raHours: 7.6875, decDeg: -9.5511, distLy: 144, mag: 3.94, constellation: 'Mon', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'beta-pav', kind: 'star', name: 'Beta Pavonis', aliases: ['beta pavonis', 'β pav'], raHours: 20.7495, decDeg: -66.2039, distLy: 137, mag: 3.42, constellation: 'Pav', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'merope', kind: 'star', name: 'Merope', aliases: ['23 tauri', 'pleiades merope'], raHours: 3.7638, decDeg: 23.9483, distLy: 380, mag: 4.14, constellation: 'Tau', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'taygeta', kind: 'star', name: 'Taygeta', aliases: ['19 tauri', 'pleiades taygeta'], raHours: 3.7534, decDeg: 24.4672, distLy: 440, mag: 4.30, constellation: 'Tau', iconClass: 'fa fa-star', color: '#c8dcff' },
  { id: 'eta-carinae', kind: 'star', name: 'Eta Carinae', aliases: ['eta carinae', 'η car', 'foramen', 'tseen she'], raHours: 10.7510, decDeg: -59.6344, distLy: 7_500, mag: 4.50, constellation: 'Car', iconClass: 'fa fa-star', color: '#ff7a4a' },
  { id: 'vy-cma', kind: 'star', name: 'VY Canis Majoris', aliases: ['vy canis majoris', 'vy cma'], raHours: 7.3849, decDeg: -25.7675, distLy: 3_900, mag: 7.95, constellation: 'CMa', iconClass: 'fa fa-star', color: '#ff4a3a' },
  { id: 'uy-scuti', kind: 'star', name: 'UY Scuti', aliases: ['uy scuti', 'uy sct'], raHours: 18.4553, decDeg: -12.6969, distLy: 5_900, mag: 8.90, constellation: 'Sct', iconClass: 'fa fa-star', color: '#ff4a3a' },
  { id: 'wolf-359', kind: 'star', name: 'Wolf 359', aliases: ['wolf 359', 'cn leo', 'gliese 406'], raHours: 10.9363, decDeg: 7.0047, distLy: 7.86, mag: 13.54, constellation: 'Leo', iconClass: 'fa fa-star', color: '#ff6b4a' },
  { id: 'tau-ceti', kind: 'star', name: 'Tau Ceti', aliases: ['tau ceti', 'τ cet'], raHours: 1.7345, decDeg: -15.9375, distLy: 11.9, mag: 3.50, constellation: 'Cet', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: '51-peg', kind: 'star', name: '51 Pegasi', aliases: ['51 pegasi', '51 peg', 'helvetios'], raHours: 22.9577, decDeg: 20.7683, distLy: 50.5, mag: 5.49, constellation: 'Peg', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'trappist-1', kind: 'star', name: 'TRAPPIST-1', aliases: ['trappist-1', 'trappist 1', '2mass j23062928-0502285'], raHours: 23.1086, decDeg: -5.0414, distLy: 40.7, mag: 18.80, constellation: 'Aqr', iconClass: 'fa fa-star', color: '#ff6b4a' },
  { id: 'kepler-452', kind: 'star', name: 'Kepler-452', aliases: ['kepler-452', 'kepler 452', 'kic 7941930'], raHours: 19.7361, decDeg: 44.2778, distLy: 1_800, mag: 13.43, constellation: 'Cyg', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'tabby', kind: 'star', name: "Tabby's Star", aliases: ['tabby', 'boyajian', 'kic 8462852', 'wtf star'], raHours: 20.1028, decDeg: 44.3336, distLy: 1_470, mag: 11.70, constellation: 'Cyg', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'r136a1', kind: 'star', name: 'R136a1', aliases: ['r136a1', 'r136 a1', 'bat99-108'], raHours: 5.6447, decDeg: -69.0958, distLy: 163_000, mag: 12.23, constellation: 'Dor', iconClass: 'fa fa-star', color: '#a8c8ff' },
  { id: 'kapteyn', kind: 'star', name: "Kapteyn's Star", aliases: ['kapteyn', 'vzon pictoris', 'hd 33793'], raHours: 5.1944, decDeg: -45.0186, distLy: 12.8, mag: 8.85, constellation: 'Pic', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'lalande-21185', kind: 'star', name: 'Lalande 21185', aliases: ['lalande 21185', 'gliese 411', 'hd 95735'], raHours: 11.0556, decDeg: 35.9486, distLy: 8.31, mag: 7.52, constellation: 'UMa', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'gliese-581', kind: 'star', name: 'Gliese 581', aliases: ['gliese 581', 'gj 581', 'ho librae'], raHours: 15.3197, decDeg: -7.7225, distLy: 20.5, mag: 10.56, constellation: 'Lib', iconClass: 'fa fa-star', color: '#ff6b4a' },
  { id: '55-cnc', kind: 'star', name: '55 Cancri', aliases: ['55 cancri', '55 cnc', 'rho1 cancri', 'copernicus'], raHours: 8.8778, decDeg: 28.3306, distLy: 41, mag: 5.95, constellation: 'Cnc', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'hd-209458', kind: 'star', name: 'HD 209458', aliases: ['hd 209458', 'v376 peg', 'osiris star'], raHours: 22.0536, decDeg: 18.8842, distLy: 159, mag: 7.65, constellation: 'Peg', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'kepler-186', kind: 'star', name: 'Kepler-186', aliases: ['kepler-186', 'kepler 186', 'kic 8120608'], raHours: 19.6056, decDeg: 43.9550, distLy: 580, mag: 14.62, constellation: 'Cyg', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'kepler-22', kind: 'star', name: 'Kepler-22', aliases: ['kepler-22', 'kepler 22', 'kic 10593626'], raHours: 19.2781, decDeg: 47.8839, distLy: 620, mag: 11.66, constellation: 'Cyg', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'wasp-12', kind: 'star', name: 'WASP-12', aliases: ['wasp-12', 'wasp 12'], raHours: 6.5094, decDeg: 29.6722, distLy: 1_410, mag: 11.57, constellation: 'Aur', iconClass: 'fa fa-star', color: '#ffe0a8' },
  { id: 'ross-128', kind: 'star', name: 'Ross 128', aliases: ['ross 128', 'fi vir', 'gliese 447'], raHours: 11.7478, decDeg: 0.8047, distLy: 11.01, mag: 11.13, constellation: 'Vir', iconClass: 'fa fa-star', color: '#ff6b4a' },
  { id: 'luyten', kind: 'star', name: "Luyten's Star", aliases: ['luyten', 'gliese 273', 'gx cnc'], raHours: 7.4394, decDeg: 5.2256, distLy: 12.36, mag: 9.87, constellation: 'CMi', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'lacaille-9352', kind: 'star', name: 'Lacaille 9352', aliases: ['lacaille 9352', 'gliese 887', 'hd 217987'], raHours: 23.0989, decDeg: -35.8531, distLy: 10.72, mag: 7.34, constellation: 'PsA', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'kruger-60', kind: 'star', name: 'Kruger 60', aliases: ['kruger 60', 'krüger 60', 'do cephei', 'gliese 860'], raHours: 22.4664, decDeg: 57.6983, distLy: 13.15, mag: 9.59, constellation: 'Cep', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'van-maanen', kind: 'star', name: "Van Maanen's Star", aliases: ['van maanen', 'gliese 35', 'wolf 28'], raHours: 0.8264, decDeg: 5.3950, distLy: 14.07, mag: 12.37, constellation: 'Psc', iconClass: 'fa fa-star', color: '#cfe0ff' },
  { id: 'teegarden', kind: 'star', name: "Teegarden's Star", aliases: ['teegarden', 'sogas-dga20', 'gat 1370'], raHours: 2.8831, decDeg: 16.8647, distLy: 12.50, mag: 15.40, constellation: 'Ari', iconClass: 'fa fa-star', color: '#ff6b4a' },
  { id: 'gliese-667c', kind: 'star', name: 'Gliese 667 C', aliases: ['gliese 667 c', 'gj 667 c', 'hr 6426 c'], raHours: 17.3156, decDeg: -34.9894, distLy: 23.62, mag: 10.22, constellation: 'Sco', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'groombridge-34', kind: 'star', name: 'Groombridge 34', aliases: ['groombridge 34', 'gx and', 'gliese 15'], raHours: 0.3053, decDeg: 44.0250, distLy: 11.62, mag: 8.08, constellation: 'And', iconClass: 'fa fa-star', color: '#ff8a6b' },
  { id: 'eps-indi', kind: 'star', name: 'Epsilon Indi', aliases: ['epsilon indi', 'ε ind'], raHours: 22.0561, decDeg: -56.7861, distLy: 11.87, mag: 4.69, constellation: 'Ind', iconClass: 'fa fa-star', color: '#ffb86b' },
  { id: 'groombridge-1830', kind: 'star', name: 'Groombridge 1830', aliases: ['groombridge 1830', 'hd 103095', 'argelander star'], raHours: 11.8833, decDeg: 37.7186, distLy: 29.7, mag: 6.42, constellation: 'UMa', iconClass: 'fa fa-star', color: '#ffe0a8' }
];
...
export const ASTRO_GALAXIES: ReadonlyArray<AstroGalaxyOption> = [
  ...
  { id: 'ngc6744', kind: 'galaxy', name: 'NGC 6744', aliases: ['ngc 6744', 'caldwell 101'], raHours: 19.1614, decDeg: -63.8575, distLy: 31_000_000, mag: 8.25, constellation: 'Pav', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'ngc2997', kind: 'galaxy', name: 'NGC 2997', aliases: ['ngc 2997'], raHours: 9.7617, decDeg: -31.1914, distLy: 25_000_000, mag: 9.40, constellation: 'Ant', iconClass: 'fa fa-circle-o', color: '#cfe0ff' },
  { id: 'ngc1097', kind: 'galaxy', name: 'NGC 1097', aliases: ['ngc 1097', 'caldwell 67'], raHours: 2.7711, decDeg: -30.2747, distLy: 45_000_000, mag: 9.50, constellation: 'For', iconClass: 'fa fa-circle-o', color: '#ffd0a8' },
  { id: 'ngc1566', kind: 'galaxy', name: 'NGC 1566', aliases: ['ngc 1566', 'spanish dancer'], raHours: 4.3333, decDeg: -54.9381, distLy: 38_000_000, mag: 9.70, constellation: 'Dor', iconClass: 'fa fa-circle-o', color: '#cfe0ff' },
  { id: 'ngc1672', kind: 'galaxy', name: 'NGC 1672', aliases: ['ngc 1672'], raHours: 4.7619, decDeg: -59.2472, distLy: 60_000_000, mag: 9.70, constellation: 'Dor', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'ngc2207', kind: 'galaxy', name: 'NGC 2207', aliases: ['ngc 2207', 'ic 2163'], raHours: 6.2736, decDeg: -21.3736, distLy: 81_000_000, mag: 10.80, constellation: 'CMa', iconClass: 'fa fa-circle-o', color: '#ffc8a0' },
  { id: 'ngc2683', kind: 'galaxy', name: 'UFO Galaxy (NGC 2683)', aliases: ['ngc 2683', 'ufo galaxy'], raHours: 8.8772, decDeg: 33.4217, distLy: 25_000_000, mag: 9.80, constellation: 'Lyn', iconClass: 'fa fa-circle-o', color: '#e0d0b0' },
  { id: 'ngc2841', kind: 'galaxy', name: 'NGC 2841', aliases: ['ngc 2841'], raHours: 9.3672, decDeg: 50.9764, distLy: 46_000_000, mag: 9.20, constellation: 'UMa', iconClass: 'fa fa-circle-o', color: '#c8d8ff' },
  { id: 'ngc3521', kind: 'galaxy', name: 'NGC 3521', aliases: ['ngc 3521', 'bubble galaxy'], raHours: 11.0972, decDeg: -0.0358, distLy: 26_000_000, mag: 9.00, constellation: 'Leo', iconClass: 'fa fa-circle-o', color: '#ffd0a8' },
  { id: 'ngc3621', kind: 'galaxy', name: 'NGC 3621', aliases: ['ngc 3621'], raHours: 11.3072, decDeg: -32.8128, distLy: 22_000_000, mag: 8.90, constellation: 'Hya', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'ngc4216', kind: 'galaxy', name: 'NGC 4216', aliases: ['ngc 4216'], raHours: 12.2658, decDeg: 13.1492, distLy: 55_000_000, mag: 10.00, constellation: 'Vir', iconClass: 'fa fa-circle-o', color: '#d0c8e8' },
  { id: 'ngc4244', kind: 'galaxy', name: 'Silver Needle (NGC 4244)', aliases: ['ngc 4244', 'caldwell 26', 'silver needle'], raHours: 12.2881, decDeg: 37.8072, distLy: 14_000_000, mag: 10.20, constellation: 'CVn', iconClass: 'fa fa-circle-o', color: '#e0d0b0' },
  { id: 'ngc4490', kind: 'galaxy', name: 'Cocoon Galaxy (NGC 4490)', aliases: ['ngc 4490', 'cocoon', 'cocon'], raHours: 12.5106, decDeg: 41.6431, distLy: 25_000_000, mag: 9.80, constellation: 'CVn', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'ngc4559', kind: 'galaxy', name: 'NGC 4559', aliases: ['ngc 4559', 'caldwell 36'], raHours: 12.5994, decDeg: 27.9592, distLy: 29_000_000, mag: 9.90, constellation: 'Com', iconClass: 'fa fa-circle-o', color: '#c8d8ff' },
  { id: 'ngc4567', kind: 'galaxy', name: 'Siamese Twins (NGC 4567/8)', aliases: ['ngc 4567', 'ngc 4568', 'siamese twins', 'butterfly'], raHours: 12.6089, decDeg: 11.2572, distLy: 59_000_000, mag: 10.90, constellation: 'Vir', iconClass: 'fa fa-circle-o', color: '#ffc8a0' },
  { id: 'ngc4676', kind: 'galaxy', name: 'Mice Galaxies (NGC 4676)', aliases: ['ngc 4676', 'mice', 'souris', 'arp 242'], raHours: 12.7678, decDeg: 30.7258, distLy: 290_000_000, mag: 13.50, constellation: 'Com', iconClass: 'fa fa-circle-o', color: '#e0d0a8' },
  { id: 'tadpole', kind: 'galaxy', name: 'Tadpole Galaxy (UGC 10214)', aliases: ['ugc 10214', 'arp 188', 'tadpole', 'tetard'], raHours: 16.1031, decDeg: 55.4272, distLy: 420_000_000, mag: 14.40, constellation: 'Dra', iconClass: 'fa fa-circle-o', color: '#cfe0ff' },
  { id: 'stephan', kind: 'galaxy', name: "Stephan's Quintet", aliases: ['ngc 7318', 'hickson 92', 'stephan', 'quintette'], raHours: 22.5992, decDeg: 33.9608, distLy: 290_000_000, mag: 13.60, constellation: 'Peg', iconClass: 'fa fa-circle-o', color: '#d0c8e8' },
  { id: 'arp273', kind: 'galaxy', name: 'Arp 273', aliases: ['arp 273', 'ugc 1810'], raHours: 2.3278, decDeg: 39.3494, distLy: 300_000_000, mag: 13.70, constellation: 'And', iconClass: 'fa fa-circle-o', color: '#c8d0ff' },
  { id: 'ngc1313', kind: 'galaxy', name: 'Topsy Turvy (NGC 1313)', aliases: ['ngc 1313', 'topsy turvy'], raHours: 3.3053, decDeg: -66.4981, distLy: 13_000_000, mag: 8.70, constellation: 'Ret', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'ngc1512', kind: 'galaxy', name: 'NGC 1512', aliases: ['ngc 1512'], raHours: 4.0811, decDeg: -43.3489, distLy: 38_000_000, mag: 10.30, constellation: 'Hor', iconClass: 'fa fa-circle-o', color: '#cfe0ff' },
  { id: 'ngc1808', kind: 'galaxy', name: 'NGC 1808', aliases: ['ngc 1808'], raHours: 5.1264, decDeg: -37.5306, distLy: 41_000_000, mag: 9.90, constellation: 'Col', iconClass: 'fa fa-circle-o', color: '#ffd0a8' },
  { id: 'ngc2442', kind: 'galaxy', name: 'Meathook (NGC 2442)', aliases: ['ngc 2442', 'meathook', 'crochet'], raHours: 7.5992, decDeg: -69.5317, distLy: 50_000_000, mag: 10.40, constellation: 'Vol', iconClass: 'fa fa-circle-o', color: '#ffc8a0' },
  { id: 'ngc3190', kind: 'galaxy', name: 'NGC 3190', aliases: ['ngc 3190', 'hickson 44', 'arp 316'], raHours: 10.3011, decDeg: 21.8322, distLy: 79_000_000, mag: 11.10, constellation: 'Leo', iconClass: 'fa fa-circle-o', color: '#e0d0b0' },
  { id: 'ngc4214', kind: 'galaxy', name: 'NGC 4214', aliases: ['ngc 4214', 'caldwell 29'], raHours: 12.2611, decDeg: 36.3269, distLy: 10_000_000, mag: 9.60, constellation: 'CVn', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'ngc4725', kind: 'galaxy', name: 'NGC 4725', aliases: ['ngc 4725'], raHours: 12.8394, decDeg: 25.5008, distLy: 40_000_000, mag: 9.40, constellation: 'Com', iconClass: 'fa fa-circle-o', color: '#c8d8ff' },
  { id: 'ngc5033', kind: 'galaxy', name: 'NGC 5033', aliases: ['ngc 5033'], raHours: 13.2272, decDeg: 36.5917, distLy: 40_000_000, mag: 10.10, constellation: 'CVn', iconClass: 'fa fa-circle-o', color: '#cfe0ff' },
  { id: 'ngc5248', kind: 'galaxy', name: 'NGC 5248', aliases: ['ngc 5248', 'caldwell 45'], raHours: 13.6253, decDeg: 8.8847, distLy: 59_000_000, mag: 10.10, constellation: 'Boo', iconClass: 'fa fa-circle-o', color: '#cfe0ff' },
  { id: 'ngc5746', kind: 'galaxy', name: 'NGC 5746', aliases: ['ngc 5746'], raHours: 14.7486, decDeg: 1.9572, distLy: 90_000_000, mag: 10.30, constellation: 'Vir', iconClass: 'fa fa-circle-o', color: '#e0d0b0' },
  { id: 'ngc6503', kind: 'galaxy', name: 'NGC 6503', aliases: ['ngc 6503'], raHours: 17.8194, decDeg: 70.1444, distLy: 17_000_000, mag: 10.20, constellation: 'Dra', iconClass: 'fa fa-circle-o', color: '#c8d8ff' },
  { id: 'ngc7814', kind: 'galaxy', name: 'NGC 7814', aliases: ['ngc 7814', 'caldwell 43', 'little sombrero'], raHours: 0.0542, decDeg: 16.1453, distLy: 40_000_000, mag: 10.60, constellation: 'Peg', iconClass: 'fa fa-circle-o', color: '#e8d0a8' },
  { id: 'ic10', kind: 'galaxy', name: 'IC 10', aliases: ['ic 10', 'ugc 192'], raHours: 0.3386, decDeg: 59.3036, distLy: 2_200_000, mag: 10.30, constellation: 'Cas', iconClass: 'fa fa-circle-o', color: '#ffe4b5' },
  { id: 'ngc1399', kind: 'galaxy', name: 'NGC 1399', aliases: ['ngc 1399', 'fornax cluster'], raHours: 3.6383, decDeg: -35.4506, distLy: 65_000_000, mag: 9.60, constellation: 'For', iconClass: 'fa fa-circle-o', color: '#c0b0e8' },
  { id: 'ngc5102', kind: 'galaxy', name: 'NGC 5102', aliases: ['ngc 5102'], raHours: 13.3161, decDeg: -36.6300, distLy: 12_000_000, mag: 9.70, constellation: 'Cen', iconClass: 'fa fa-circle-o', color: '#e0d0b0' },
  { id: 'ngc5253', kind: 'galaxy', name: 'NGC 5253', aliases: ['ngc 5253'], raHours: 13.6997, decDeg: -31.6400, distLy: 11_000_000, mag: 10.40, constellation: 'Cen', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'carina-dwarf', kind: 'galaxy', name: 'Carina Dwarf', aliases: ['carina dwarf', 'eso 206-20'], raHours: 6.6972, decDeg: -50.9661, distLy: 330_000, mag: 10.60, constellation: 'Car', iconClass: 'fa fa-circle-o', color: '#e0d0b0' },
  { id: 'draco-dwarf', kind: 'galaxy', name: 'Draco Dwarf', aliases: ['draco dwarf', 'ugc 10822'], raHours: 17.3378, decDeg: 57.9153, distLy: 260_000, mag: 10.90, constellation: 'Dra', iconClass: 'fa fa-circle-o', color: '#d8c8b0' },
  { id: 'umi-dwarf', kind: 'galaxy', name: 'Ursa Minor Dwarf', aliases: ['ursa minor dwarf', 'ugc 9749'], raHours: 15.1561, decDeg: 67.2228, distLy: 200_000, mag: 10.90, constellation: 'UMi', iconClass: 'fa fa-circle-o', color: '#d8c8b0' },
  ...
  { id: 'ngc1275', kind: 'galaxy', name: 'Perseus A (NGC 1275)', aliases: ['ngc 1275', 'perseus a', '3c 84', 'caldwell 24'], raHours: 3.3314, decDeg: 41.5117, distLy: 230_000_000, mag: 11.90, constellation: 'Per', iconClass: 'fa fa-circle-o', color: '#c8d0ff' },
  { id: 'eso137-001', kind: 'galaxy', name: 'Jellyfish Galaxy (ESO 137-001)', aliases: ['eso 137-001', 'jellyfish', 'meduse'], raHours: 16.2444, decDeg: -60.7667, distLy: 220_000_000, mag: 14.50, constellation: 'TrA', iconClass: 'fa fa-circle-o', color: '#67e8f9' },
  { id: 'malin1', kind: 'galaxy', name: 'Malin 1', aliases: ['malin 1', 'led 43770'], raHours: 12.6147, decDeg: 14.3306, distLy: 1_200_000_000, mag: 15.70, constellation: 'Com', iconClass: 'fa fa-circle-o', color: '#a090c8' },
  { id: 'ugc2885', kind: 'galaxy', name: "Rubin's Galaxy (UGC 2885)", aliases: ['ugc 2885', 'rubin galaxy'], raHours: 3.9228, decDeg: 35.5917, distLy: 232_000_000, mag: 13.50, constellation: 'Per', iconClass: 'fa fa-circle-o', color: '#cfe0ff' },
  { id: 'i-zwicky-18', kind: 'galaxy', name: 'I Zwicky 18', aliases: ['i zwicky 18', 'mrk 116', 'ugc 4305'], raHours: 9.5669, decDeg: 55.2417, distLy: 59_000_000, mag: 16.00, constellation: 'UMa', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'cygnus-a', kind: 'galaxy', name: 'Cygnus A', aliases: ['cygnus a', '3c 405', 'cyg a'], raHours: 19.9914, decDeg: 40.7339, distLy: 600_000_000, mag: 15.10, constellation: 'Cyg', iconClass: 'fa fa-circle-o', color: '#b0a8ff' },
  { id: 'hercules-a', kind: 'galaxy', name: 'Hercules A', aliases: ['hercules a', '3c 348'], raHours: 16.8522, decDeg: 4.9928, distLy: 2_100_000_000, mag: 16.90, constellation: 'Her', iconClass: 'fa fa-circle-o', color: '#a090c8' },
  { id: 'ngc4889', kind: 'galaxy', name: 'NGC 4889', aliases: ['ngc 4889', 'coma cluster'], raHours: 13.0036, decDeg: 27.9756, distLy: 308_000_000, mag: 11.50, constellation: 'Com', iconClass: 'fa fa-circle-o', color: '#c0b0e8' },
  { id: 'arp220', kind: 'galaxy', name: 'Arp 220', aliases: ['arp 220', 'ic 4553', 'ulirg'], raHours: 15.5794, decDeg: 23.5031, distLy: 250_000_000, mag: 13.20, constellation: 'Ser', iconClass: 'fa fa-circle-o', color: '#ffc8a0' },
  { id: 'mayall', kind: 'galaxy', name: "Mayall's Object", aliases: ['mayall', 'arp 148', 'vv 32'], raHours: 12.3897, decDeg: 32.3806, distLy: 450_000_000, mag: 15.00, constellation: 'UMa', iconClass: 'fa fa-circle-o', color: '#c8d0ff' },
  { id: 'ngc3314', kind: 'galaxy', name: 'NGC 3314', aliases: ['ngc 3314'], raHours: 10.6186, decDeg: -27.6850, distLy: 117_000_000, mag: 13.50, constellation: 'Hya', iconClass: 'fa fa-circle-o', color: '#ffe0b0' },
  { id: 'ngc7714', kind: 'galaxy', name: 'NGC 7714', aliases: ['ngc 7714', 'arp 284'], raHours: 23.6056, decDeg: 2.1550, distLy: 100_000_000, mag: 12.50, constellation: 'Psc', iconClass: 'fa fa-circle-o', color: '#ffc8a0' },
  { id: 'ngc1277', kind: 'galaxy', name: 'NGC 1277', aliases: ['ngc 1277'], raHours: 3.3319, decDeg: 41.4733, distLy: 220_000_000, mag: 14.70, constellation: 'Per', iconClass: 'fa fa-circle-o', color: '#c0b0e8' }
];
...
export const ASTRO_DEEPSKY: ReadonlyArray<AstroDeepSkyOption> = [
  ...
  { id: 'm43', kind: 'deepsky', subtype: 'nebula', name: "De Mairan's Nebula (M43)", aliases: ['m43', 'ngc 1982', 'de mairan'], raHours: 5.5919, decDeg: -5.2700, distLy: 1_600, mag: 9.0, constellation: 'Ori', iconClass: 'fa fa-cloud', color: '#fda4af' },
  { id: 'm78', kind: 'deepsky', subtype: 'nebula', name: 'M78', aliases: ['m78', 'ngc 2068'], raHours: 5.7792, decDeg: 0.0817, distLy: 1_350, mag: 8.3, constellation: 'Ori', iconClass: 'fa fa-cloud', color: '#f9a8d4' },
  { id: 'witch-head', kind: 'deepsky', subtype: 'nebula', name: 'Witch Head (IC 2118)', aliases: ['ic 2118', 'witch head', 'tete de sorciere', 'tête de sorcière'], raHours: 5.1083, decDeg: -7.2000, distLy: 900, mag: 10.0, constellation: 'Eri', iconClass: 'fa fa-cloud', color: '#7dd3fc' },
  { id: 'pelican', kind: 'deepsky', subtype: 'nebula', name: 'Pelican Nebula (IC 5070)', aliases: ['ic 5070', 'pelican', 'pelican nebula', 'pelican'], raHours: 20.8500, decDeg: 44.3667, distLy: 1_800, mag: 8.0, constellation: 'Cyg', iconClass: 'fa fa-cloud', color: '#fda4af' },
  { id: 'elephant-trunk', kind: 'deepsky', subtype: 'nebula', name: 'Elephant Trunk (IC 1396)', aliases: ['ic 1396', 'elephant trunk', 'trompe', 'caldwell 86'], raHours: 21.6150, decDeg: 57.5000, distLy: 2_400, mag: 5.6, constellation: 'Cep', iconClass: 'fa fa-cloud', color: '#fb7185' },
  { id: 'heart-neb', kind: 'deepsky', subtype: 'nebula', name: 'Heart Nebula (IC 1805)', aliases: ['ic 1805', 'heart nebula', 'coeur', 'cœur', 'soulmate'], raHours: 2.5444, decDeg: 61.4500, distLy: 7_500, mag: 6.5, constellation: 'Cas', iconClass: 'fa fa-cloud', color: '#fb7185' },
  { id: 'soul-neb', kind: 'deepsky', subtype: 'nebula', name: 'Soul Nebula (IC 1848)', aliases: ['ic 1848', 'soul nebula', 'ame', 'âme', 'westerhout 5'], raHours: 2.8511, decDeg: 60.4000, distLy: 6_500, mag: 6.5, constellation: 'Cas', iconClass: 'fa fa-cloud', color: '#f9a8d4' },
  { id: 'running-man', kind: 'deepsky', subtype: 'nebula', name: 'Running Man (NGC 1977)', aliases: ['ngc 1977', 'running man', 'coureur'], raHours: 5.5883, decDeg: -4.8700, distLy: 1_500, mag: 6.3, constellation: 'Ori', iconClass: 'fa fa-cloud', color: '#7dd3fc' },
  { id: 'cone', kind: 'deepsky', subtype: 'nebula', name: 'Cone / Christmas Tree (NGC 2264)', aliases: ['ngc 2264', 'cone nebula', 'christmas tree', 'sapin', 'cone'], raHours: 6.6828, decDeg: 9.8917, distLy: 2_600, mag: 3.9, constellation: 'Mon', iconClass: 'fa fa-cloud', color: '#fda4af' },
  { id: 'flaming-star', kind: 'deepsky', subtype: 'nebula', name: 'Flaming Star (IC 405)', aliases: ['ic 405', 'caldwell 31', 'flaming star', 'etoile flamboyante'], raHours: 5.2722, decDeg: 34.2667, distLy: 1_500, mag: 6.0, constellation: 'Aur', iconClass: 'fa fa-cloud', color: '#fb923c' },
  { id: 'm35', kind: 'deepsky', subtype: 'cluster', name: 'M35', aliases: ['m35', 'ngc 2168'], raHours: 6.1483, decDeg: 24.3333, distLy: 2_800, mag: 5.1, constellation: 'Gem', iconClass: 'fa fa-asterisk', color: '#fde047' },
  { id: 'm36', kind: 'deepsky', subtype: 'cluster', name: 'M36', aliases: ['m36', 'ngc 1960'], raHours: 5.6017, decDeg: 34.1333, distLy: 4_100, mag: 6.0, constellation: 'Aur', iconClass: 'fa fa-asterisk', color: '#facc15' },
  { id: 'm37', kind: 'deepsky', subtype: 'cluster', name: 'M37', aliases: ['m37', 'ngc 2099'], raHours: 5.8717, decDeg: 32.5500, distLy: 4_500, mag: 5.6, constellation: 'Aur', iconClass: 'fa fa-asterisk', color: '#fde047' },
  { id: 'm38', kind: 'deepsky', subtype: 'cluster', name: 'M38', aliases: ['m38', 'ngc 1912'], raHours: 5.4783, decDeg: 35.8333, distLy: 4_200, mag: 6.4, constellation: 'Aur', iconClass: 'fa fa-asterisk', color: '#fef08a' },
  { id: 'm41', kind: 'deepsky', subtype: 'cluster', name: 'M41', aliases: ['m41', 'ngc 2287'], raHours: 6.7667, decDeg: -20.7333, distLy: 2_300, mag: 4.5, constellation: 'CMa', iconClass: 'fa fa-asterisk', color: '#fde047' },
  { id: 'm46', kind: 'deepsky', subtype: 'cluster', name: 'M46', aliases: ['m46', 'ngc 2437'], raHours: 7.6967, decDeg: -14.8167, distLy: 5_400, mag: 6.1, constellation: 'Pup', iconClass: 'fa fa-asterisk', color: '#facc15' },
  { id: 'm47', kind: 'deepsky', subtype: 'cluster', name: 'M47', aliases: ['m47', 'ngc 2422'], raHours: 7.6100, decDeg: -14.5000, distLy: 1_600, mag: 4.2, constellation: 'Pup', iconClass: 'fa fa-asterisk', color: '#fde047' },
  { id: 'm48', kind: 'deepsky', subtype: 'cluster', name: 'M48', aliases: ['m48', 'ngc 2548'], raHours: 8.2283, decDeg: -5.8000, distLy: 1_500, mag: 5.8, constellation: 'Hya', iconClass: 'fa fa-asterisk', color: '#fef08a' },
  { id: 'm50', kind: 'deepsky', subtype: 'cluster', name: 'M50', aliases: ['m50', 'ngc 2323'], raHours: 7.0533, decDeg: -8.3333, distLy: 3_200, mag: 5.9, constellation: 'Mon', iconClass: 'fa fa-asterisk', color: '#facc15' },
  { id: 'm52', kind: 'deepsky', subtype: 'cluster', name: 'M52', aliases: ['m52', 'ngc 7654'], raHours: 23.4033, decDeg: 61.5933, distLy: 4_600, mag: 6.9, constellation: 'Cas', iconClass: 'fa fa-asterisk', color: '#fde047' },
  { id: 'm53', kind: 'deepsky', subtype: 'cluster', name: 'M53', aliases: ['m53', 'ngc 5024'], raHours: 13.2150, decDeg: 18.1683, distLy: 58_000, mag: 7.6, constellation: 'Com', iconClass: 'fa fa-asterisk', color: '#fbbf24' },
  { id: 'm67', kind: 'deepsky', subtype: 'cluster', name: 'M67', aliases: ['m67', 'ngc 2682'], raHours: 8.8550, decDeg: 11.8000, distLy: 2_700, mag: 6.1, constellation: 'Cnc', iconClass: 'fa fa-asterisk', color: '#fde047' },
  { id: 'm71', kind: 'deepsky', subtype: 'cluster', name: 'M71', aliases: ['m71', 'ngc 6838'], raHours: 19.8967, decDeg: 18.7792, distLy: 13_000, mag: 6.1, constellation: 'Sge', iconClass: 'fa fa-asterisk', color: '#facc15' },
  { id: 'm80', kind: 'deepsky', subtype: 'cluster', name: 'M80', aliases: ['m80', 'ngc 6093'], raHours: 16.2842, decDeg: -22.9753, distLy: 32_600, mag: 7.3, constellation: 'Sco', iconClass: 'fa fa-asterisk', color: '#fbbf24' },
  { id: 'm93', kind: 'deepsky', subtype: 'cluster', name: 'M93', aliases: ['m93', 'ngc 2447'], raHours: 7.7422, decDeg: -23.8667, distLy: 3_600, mag: 6.2, constellation: 'Pup', iconClass: 'fa fa-asterisk', color: '#fde047' }
];
