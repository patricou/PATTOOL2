...
export const ASSISTANT_MISTRAL_MODEL_GUIDE_ROWS: readonly AssistantMistralModelGuideRow[] = [
  {
    modelNameKey: 'ASSISTANT.TOOLS_HELP_MISTRAL_MEDIUM_NAME',
    apiModelId: 'mistral-medium-latest',
    badgeKey: 'ASSISTANT.TOOLS_HELP_MISTRAL_MEDIUM_BADGE',
    useKeys: [
      'ASSISTANT.TOOLS_HELP_MISTRAL_MEDIUM_U1',
      'ASSISTANT.TOOLS_HELP_MISTRAL_MEDIUM_U2',
      'ASSISTANT.TOOLS_HELP_MISTRAL_MEDIUM_U3'
    ]
  },
  {
